...
while True:
        ...
        # apply model on the interested region
        results = model(imgRegion, stream=True)
        # initial an empty detection array
        ...
        for r in results:
                ...
                for box in boxes:
                        ...
                        if (currentClass=="car" or currentClass=='truck' or currentClass=="bus") and conf>0.4:
                                ...
                                # show text
                                cv.putText(img, f'{classNames[cls]} {conf}', (max(0, x1), max(35, y1)), cv.FONT_HERSHEY_TRIPLEX, 0.6, (0,0,255), 1)
